...
const AttendanceTable = ({ records, loading, emptyMessage }: AttendanceTableProps) => {
  ...
  if (records.length === 0) {
    return (
      <div className="bg-white rounded-xl shadow-lg p-4 sm:p-8 text-center">
        ...
        <h3 className="text-sm sm:text-lg font-medium text-gray-900 mb-2">{emptyMessage || 'No attendance records found'}</h3>
        {!emptyMessage && (
