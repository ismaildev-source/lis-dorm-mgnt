...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-lg py-3 px-4 text-sm outline-none hover:bg-gray-50 focus:bg-gray-50 focus:text-gray-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 border-b border-gray-100 last:border-b-0",
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.ItemText className="ml-6 text-gray-800 font-medium">{children}</SelectPrimitive.ItemText>
  </SelectPrimitive.Item>
))
